...
void ComputeWalkDestination(uint16_t originX, uint16_t originY, BYTE direction,
    ...
    destY = originY;
    switch (direction) {
    case 0: destY = originY - 1; break;
    case 1: destX = originX + 1; break;
    case 2: destY = originY + 1; break;
    case 3: destX = originX - 1; break;
    }
}
...
// Caller holds charDataMutex. Update entity position+direction in storedShowUsers.
void PatchShowUserPosition(uint32_t entityId, uint16_t destX, uint16_t destY, BYTE direction) {
